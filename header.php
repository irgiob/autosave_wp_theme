            ...
            <div class="p-4">
                <div class="row">
                    <div class="col-md-2 col-12 fs-1">
                        <p class="fw-bold hover-underline-animation"><a class="link-container" href="<?php get_home_url() ?>">Anime</a></p><br>
                        <p class="fw-bold hover-underline-animation"><a class="link-container" href="<?php get_home_url() ?>">Tech</a></p><br>
